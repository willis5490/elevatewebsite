       ...
       <nav id = 'header' className="uk-navbar-container uk-margin" uk-navbar='true' uk-navbar="mode: click">
            <div className="uk-navbar-left uk-visible@m ">
                <ul className="uk-navbar-nav">
                    <li className=""><a href = "/"><img id='logo-nav' src = "../Images/download.png"></img></a></li>
                            ...
                            <div className="uk-offcanvas-bar">
                                <ul className="uk-nav uk-nav-default">
                                    <li className="uk-nav-header">
                                        ...
                                        <img id='logoMobile' className="uk-margin-small-right" src="../Images/download.png" width="50" height="50" alt="" uk-img></img>
                                    </li>
